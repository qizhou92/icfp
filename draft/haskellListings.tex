...
%%           {subString}{subStr}6
	...
	emph=
	{[2] 	Show,Eq,Ord,Num,UpClosed,Comp,Wit,Witness,Meet,Flip,TRUE,Nat,Pos,Neg,IntGE,Plus,List,
	...
	{[3]
		...
		, Theorem, Proof, Qed, QED, Definition, match, with , end, Fixpoint, Type, 
		Axiom, assume, exists, Lemma, Prop, Inductive, as
	},
