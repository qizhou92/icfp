...
\BH{define relational types, parameterizd on indices}

\BH{declare typing relation: assigns tuple of expressions to
  relational type}
...
\BH{define contextual relational type: base symbols are variables}

\BH{define context}

\BH{define typing relation over expressions in terms of positioned
  expressions}
