...
\begin{figure}
  \centering
  \begin{gather*}
    \inference[ ATOMS ]{ }{ A \reltyof \tau_A } 
  ...
  \end{gather*}
  \caption{Inductive inference rules that define the property of a relational refinement type that it constrains equivalence over indicies $i$ and $j$.
    %
...
% define judgment:
\autoref{fig:structure-rel} contains a set of inductive inference
rules that define the correspondence from structural types to
relational refinement types.
%
