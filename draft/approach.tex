...
% define consistency of type positions:
...
%
\BH{replace this by defining positions of types, then defining
  relational types in terms of component types that exist?}

% define indexed positions:
