...
$I$ is %
\textbf{(1)} a map
$\Phi : \pset(\idxpos{I}) \partto \refpreds{ \idxpos{I} }$ such that
for each $J \subseteq \idxpos{I}$ bound in $\Phi$,
$\Phi(J) \in \refpreds{J}$;
%
\textbf{(2)} an equivalence relation over $\lfpvars$.
%
...
relational refinement predicates and an equivalence relation over
% 
