      ...
      \Switch{$\solvechc(\mathcal{S})$ %
        ...
        \Case{$D \in \ders{ \mathcal{S} }$ %
          ...
          \Switch{$\isvalidcex(D)$ \label{line:vders-chk-cex}}{
            \Case{$\isvalid$ \label{line:vders-subcase-valid} }{
...
%
\BH{define algorithm that checks inductiveness of given relational
  invariants}
...
%
\BH{hoist definition of tilings}

% 
\BH{walk through verifydersaux}
