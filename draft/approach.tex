...
\begin{figure}
  ...
  \begin{gather*}
    ...
    \inference[ CONST ]{ %
      ...
      \Gamma \judges E : \tau & %
      % tau is subtype under constraint that p is c
    ...
    \inference[ ABS ]{ 
      ...
      % project the result to remove x,
      \tau' \subtype^x \tau'' }{ %
    ...
    \inference[ PAIR ]{
      ...
      \Gamma \judges \upd{E}{p}{ \pair{e_0}{e_1} } : \tau^p } \\
    % let:
    \inference[ LET ]{
      % get type of bound expression,
      \Gamma \judges \upd{ E }{p}{ e_0 } : \tau^p &
      % project out x and y,
      \tau' \subtype^{\cc{x}, \cc{y}} \tau'' \\
...
% walk through the inference rules:
