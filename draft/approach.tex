...
% extend to sequences of positions and program variables:
For $\tau \in \reltypes$, positions $P = p_0, \ldots, p_n$ and program
variables $X = x_0, \ldots, x_n$, the sequence of joins
$(\ldots(\tau \joinctr_{p_0} x_0) \joinctr \ldots) \joinctr_{p_n} x_n$
is denoted $\tau \joinctr_{P} X$.
...
\begin{figure}
  ...
  \begin{gather*}
    ...
    \inference[ EMPTY ]{ }{
      ...
      \Gamma, \gamma \judges \emptyset : \gamma } \qquad
    % constant:
    \inference[ CONST ]{ %
