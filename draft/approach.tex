...
\begin{algorithm}[H]
  ...
  { \myproc{$\verifyaux(T \in \unfoldreltypes{ P_0 }{ P_1 })$ %
      ...
      \Switch{$\chkinductive(T)$ %
        ...
        \Case{$d_0 \in \progders{ \cc{P}_0 }$, %
          ...
          \Switch{$\verifyders(d_0, d_1)$ \label{line:core-vders} }{ %
            ...
            \lCase{$T' \in \unfoldreltypes{ P_0 }{ P_1 }$: %
              \label{line:core-subcase-invs} }{ %
              \Return{ $\verifyaux(\mergeinvs(T, T'))$ } %
...
Otherwise, \verifyders returns $T' \in \unfoldreltypes{d_0}{d_1}$
