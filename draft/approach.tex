...
%
For indicies $I$, $\mathcal{X} \subseteq \lfpvars$, %
$N : \mathcal{X} \to I$, %
$P : \mathcal{X} \to \typos$, %
$\mathcal{M} \in \equiv_{\mathcal{X}}$, and %
$\mathcal{Y} \in \mathcal{C}_{\mathcal{M}}$, the
%
the indexed type positions defined by $N$, $P$, and $\mathcal{Y}$, is
$m_{\mathcal{Y}}^{N, P} = \inv{ \restrict{N}{ \mathcal{Y} } } \compose
P$.

\BH{prefixing of indexed refinement predicate with map}

\BH{prefixing of var -> position map}

% define the substitution of relational types:
For indicies $I$, $\mathcal{X} \subseteq \lfpvars$, %
$\Phi, \Phi' \in \idxrefpreds{ \mathcal{X} }$, %
$N : \mathcal{X} \to I$, %
...
$\replace{ (\Phi, N, P, \mathcal{M}) }{ \mathcal{Y} }{ (\Phi', N, P',
  \mathcal{M}) } = (\Phi \union \Phi'', N, P \union P'',
\mathcal{M})$, where for $m = m_{\mathcal{Y}}^{N, P}$,
$\Phi'' = m \concat \Phi'$ and $P'' = m \concat P'$.
