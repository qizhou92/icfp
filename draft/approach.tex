...
$\Phi : \idxrefpreds{I}$, $N : X \to I$, $P : X \to \idxpos{I}$, and
$E \subseteq X \times X$, the abstraction of $(\Phi, N, P, E)$ over
$x$ at $i$ is
$\to_x^i (\Phi, N, P, E) = (\renamefn{j}{i} \compose \Phi'
\compose..., %
N \compose \renamefn{x}{i}, %
P \compose \prependfn{N}{P}{x}{\typaramfield} \compose
\prependfn{N}{P}{i}{\tyresfield}, E)$.
